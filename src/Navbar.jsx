...
import { getImagen } from './api/imagenes';

function Navbar({idUser}) {
    ...
    return (
        <nav className="navbar">
            ...
            <div>
                <div style={{color: 'white'}}><Link to="/Perfil"><img src={imageUrl} style={{ width: '40px', height: '40px' }}></img></Link></div>
            </div>
